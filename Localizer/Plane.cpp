...
{
	Vector3 vec3v1tov2 = v2 - v1;
	Vector3 vec3v1tov3 = v3 - v1;
	Vector3 v3Normal;

	v3Normal = vec3v1tov2.cross(vec3v1tov3).normalize();
	this->set(v3Normal, v1);
}
...
Line Plane::intersect(const Plane& rhs) const
{
    ...
    if(v.x == 0 && v.y == 0 && v.z == 0)
        return Line(Vector3(INFINITY, INFINITY, INFINITY), Vector3(INFINITY, INFINITY, INFINITY));
